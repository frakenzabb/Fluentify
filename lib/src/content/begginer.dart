...
import 'package:coba_uas/src/content/begginer/begginer1.dart';
import 'package:coba_uas/src/content/begginer/begginner2.dart';
import 'package:coba_uas/src/content/begginer/begginer3.dart';

class CardListScreenBegginer extends StatelessWidget {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          switch (index) {
                            case 0:
                              return Begginer1(); // Greetings and Introductions
                            case 1:
                              return Begginner2(); // Numbers and Basic Vocabularies
                            case 2:
                              return Begginer3(); // Daily Activities
                            default:
