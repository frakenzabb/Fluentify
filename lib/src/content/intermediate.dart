...
import 'package:coba_uas/src/content/intermediate/intermediate1.dart';
import 'package:coba_uas/src/content/intermediate/intermediate2.dart';
import 'package:coba_uas/src/content/intermediate/intermediate3.dart';

class CardListScreenInter extends StatelessWidget {
  final List<CardItem> cardItems = [
    CardItem(
      imagePath: 'assets/inter/describing.jpg',
    ...
    CardItem(
      imagePath: 'assets/inter/grammar.jpg',
    ...
    CardItem(
      imagePath: 'assets/inter/vocab.jpg',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Intermediate Lessons'),
        leading: IconButton(
